 ...
 *
 *  Note: for the SafeCast Onyx (STM32 target), this is required
 */
 ...
 *
 *  Note: for the Onyx, with very limited memory, 5 is more than enough.
 */
#define JSON_SECURITY_MAX_NEST_LEVEL 5
 ...
 *
 *  Note: for the Onyx, 1024 characters more than enough
 */
#define JSON_SECURITY_MAX_STRING_LENGTH 1024
